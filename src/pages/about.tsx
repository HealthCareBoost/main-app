...
import { Linkedin, LinkedinIcon, Mail, MoreVertical } from "lucide-react";
      ...
      <main className={`py-4`}>
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-2 p-4 sm:grid-cols-3 lg:grid-cols-5">
            ...
            <div
              className={`${styles.paragraph} p-3 text-justify sm:col-span-2 md:pl-0 lg:py-4 lg:px-6`}
            >
              <p>
                Hello! I am Genadi, the sole developer behind LetMeCook. I have
                a great interest for developing software that improves
                people&apos;s lives and makes a difference. I am also passionate
                about cooking and living healthy life.
              </p>
              <p>
            ...
            >
              I&apos;m always excited to connect with users and fellow
              developers. Feel free to reach out with feedback, ideas, or just
              to say hello. You can contact me at{" "}
